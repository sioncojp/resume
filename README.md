...
# 自身の強み
事業を立ち上げて、コード書いて、事業として短期~中長期なにをしていくのか。
チームをどう構成して率いてメッセージを発信していくか
様々なレイヤーを事業 * チームを大事にステークホルダーと会話しながら勧めてきました。
重圧、期待値、経験など高負荷の中で苦しみながら実績積んできたのが強みだと思います。

例えば、エンジニアからEMになるような役割の変え方ではなく、
コーポレートエンジニアしたり、CTO, COOなど大きくロールを変え続けられてきたのは他人にない強みです。
